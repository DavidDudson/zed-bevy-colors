...
this. The `zed-extension` crate uses `#![warn(missing_docs)]` (not
`deny`) because its only public symbol is generated by the
`zed::register_extension!` macro and cannot carry a doc comment.
